...
function FinalUi({ ViewTrip, disable }: any) {
    return (
        <div className='flex flex-col items-center justify-center mt-6 p-6 bg-card rounded-2xl mb-2'>
            ...
            <button disabled={disable} onClick={ViewTrip} className='my-3 w-full bg-primary text-white py-2 rounded-full hover:shadow-blue-300 hover:shadow-lg transition-shadow shadow-sm text-center'>
                View Trip
            </button>
        </div>
    )
