...
function EmptyBoxState({ onSelectOption }: any) {
  return (
    <div className='mt-7'>
      ...
      <p className='text-center text-muted-foreground mt-2'>Discover personalized itineraries, find the best destinations, and plan your dream vacation effortlessly with the power of AI. Let Wander Wise do the hard work while you enjoy the journey.</p>
