...
import IndiaChatBox from './_components/IndiaChatBox';
...
function CreateNewTrip() {
    ...
    const hasPremiumAccess = has ? has({ plan: 'monthly' }) : false;
    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-3 gap-3 p-5'>
            <div>
                {/* Show India chat for Free users, Global chat for Pro users */}
                {hasPremiumAccess ? (
                    <ChatBox />
                ) : (
                    <IndiaChatBox />
            ...
            <div className='col-span-2 relative'>
                ...
                {/* Only show map switch for Pro users */}
                {hasPremiumAccess && (
                    <Tooltip>
