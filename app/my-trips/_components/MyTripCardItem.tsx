...
function MyTripCardItem({trip}:props) {
  ...
  return (
      <Link href={'/view-trips/'+trip?.tripId} className='p-5 rounded-2xl hover:shadow-xl hover:shadow-primary/30 hover:scale-105 transition-transform duration-300 ease-in'>
