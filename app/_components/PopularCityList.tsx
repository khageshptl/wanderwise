...
export function PopularCityList() {
    return (
        <div className="w-full py-12 relative overflow-hidden target snap-start bg-background flex flex-col items-center">
            <h2 className="max-w-7xl pl-4 mx-auto text-2xl md:text-3xl font-bold gradient-text font-sans z-10 mb-4 text-center">
                Popular Destination to Visit
            </h2>
            <CoverFlowCarousel items={data} />
        </div>
    );
}
